    ...
    return (
        <Layout hasTabBar title="동네생활">
            <div className="space-y-4 divide-y-[2px]">
                {[1, 2, 3, 4, 5, 6].map((_, i) => (
                    <Link key={i} href={`/community/${i}`} className="flex cursor-pointer flex-col pt-4 items-start">
              <span
                ...
                동네질문
                        ...
                        <div
                            className="mt-5 px-4 flex items-center justify-between w-full text-gray-500 font-medium text-xs">
                            <span>니꼬</span>
                            <span>18시간 전</span>
                        </div>
